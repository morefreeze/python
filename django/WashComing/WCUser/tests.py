...
class UserTest(TestCase):
    ...
    def test_info(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertJSONEqual(res.content, {'email':'unittest7@qq.com','exp':0,'level':42,'score':0,'token':s_token,'avatar':'','uid':s_uid,'username':'unittest7@qq.com','is_active':1, 'errno':0})
